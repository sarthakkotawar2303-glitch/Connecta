...
/**
 * Returns true if a message is within the 15-minute edit window.
 */
...
/**
 * Formats a lastSeen timestamp into a human-readable string.
 */
...
/**
 * Formats a message timestamp as relative text (e.g. "just now", "3h ago").
 */
